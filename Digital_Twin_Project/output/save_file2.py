...
class Thread1(QThread):
    ...
    def run(self):
        global save_path1, save_path2,save_path3,save_path4,save_path5,save_path6,save_path7,save_path8,save_path9
        try:
            now = datetime.now()
            ...
            cur = con.cursor()
            cur.execute('SELECT lat, long,rtsp_path FROM rtsp WHERE save_path IS NULL ORDER BY ID DESC LIMIT 9')
            a=cur.fetchall()
            longitude1 = a[8][1]
            latitude1 = a[8][0]
            longitude2 = a[7][1]
            ...
            save_path7 = f'{save_path}\\seoul_dongdaemungu_{longitude7}_{latitude7}SEOULCCTV_E_1.avi'
            save_path8 = f'{save_path}\\seoul_dongdaemungu_{longitude8}_{latitude8}SEOULCCTV_E_2.avi'
            save_path9 = f'{save_path}\\seoul_dongdaemungu_{longitude9}_{latitude9}SEOULCCTV_E_3.avi'
