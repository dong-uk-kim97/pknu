...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def save_db(self):
        ...
        text33 = 'rtsp://210.99.70.120:1935/live/cctv018.stream'
        text34=text33.split('/')
        text35=text34[-1].split('.')
        text36=text35[0]
        
        s5 = "37.5755901,127.0232426"
        w5 = s5.split(',')
        lat5 = w5[0]
        long5 = w5[1]
        ...
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text4,text1,lat1,long1))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text8,text5,lat1,long1))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text12,text9,lat2,long2))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text16,text13,lat3,long3))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text20,text17,lat3,long3))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text24,text21,lat4,long4))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text28,text25,lat5,long5))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text32,text29,lat5,long5))
        cur.execute("INSERT INTO rtsp (name,rtsp_path,lat,long) VALUES (?,?,?,?);", (text36,text33,lat5,long5))
        con.commit()
        con.close() 
