...
if str(ROOT) not in sys.path: # 만약 ROOT가 없다면 
    sys.path.append(str(ROOT))  # add ROOT to PATH 한번 더 시도
...
def parse_opt():
    ...
    parser.add_argument("--conf-thres", type=float, default=0.2, help="confidence threshold") # 인식률 설정
    parser.add_argument("--iou-thres", type=float, default=0.2, help="NMS IoU threshold") # 인식률 설정
