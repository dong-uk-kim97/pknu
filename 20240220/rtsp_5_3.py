...
########################################################################################        
    ...
    def start_thread(self):
        ...
        self.th3.start()   
        self.th4.start()
        print(list_1[0],list_1[1],list_1[2],list_1[3]+'입니다.')
        os.system('cd C:\\study && cd 20240220 && python save_file.py')
...
class Thread(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            cur = con.cursor()
            cur.execute(f'SELECT path FROM Rtsp WHERE name="{list_1[0]}"')
            path = cur.fetchone()
...
class Thread2(QThread):
    ...
    def run(self):
        ...
        con = sqlite3.connect('C:\\study\\20240219\\rtsp.db')
        cur = con.cursor()
        cur.execute(f'SELECT path FROM Rtsp WHERE name="{list_1[1]}"')
        path = cur.fetchone()
...
class Thread3(QThread):
    ...
    def run(self):
        ...
        con = sqlite3.connect('C:\\study\\20240219\\rtsp.db')
        cur = con.cursor()
        cur.execute(f'SELECT path FROM Rtsp WHERE name="{list_1[2]}"')
        path = cur.fetchone()
...
class Thread4(QThread):
    ...
    def run(self):
        ...
        con = sqlite3.connect('C:\\study\\20240219\\rtsp.db')
        cur = con.cursor()
        cur.execute(f'SELECT path FROM Rtsp WHERE name="{list_1[3]}"')
        path = cur.fetchone()
